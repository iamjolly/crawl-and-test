...
As the maintainers and contributors of CATS (Crawl and Test System), an
accessibility testing platform, we are committed to fostering an environment
that respects and promotes the dignity, rights, and contributions of all
individuals, regardless of characteristics including race, ethnicity, caste,
color, age, physical characteristics, neurodiversity, disability, sex or gender,
gender identity or expression, sexual orientation, language, philosophy or
religion, national or social origin, socio-economic position, level of
education, or other status.

**Our commitment to accessibility extends beyond our code to our community.** We
believe that a project dedicated to improving web accessibility must itself be a
model of inclusive and accessible participation. The same privileges of
...
7. **Creating accessible content** in all forms of communication (clear
   language, proper markup, descriptive link text, etc.).
8. **Supporting inclusive design** and accessibility best practices in all
   contributions.
9. **Being patient and helpful** when others are learning about accessibility
   concepts.
10. Behaving in other ways that promote and sustain the **well-being of our
    community**.
...
possible violation, please:

- **Create a private issue** on GitHub and tag the project maintainers
- **Email the project maintainer** at the contact information provided in the
  repository
- **Use GitHub's reporting features** for serious violations

Please provide as much detail as you care to share and let us know whether you
would like to be contacted if additional information is needed.
