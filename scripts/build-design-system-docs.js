...
try {
  ...
  execSync(
    `sass src/styles/design-system/testing/_testing.scss ${testingDir}/_testing.css --style ${sassStyle}`,
    {
      stdio: 'inherit',
    }
  );
  ...
  // Step 8: Copy README
  fs.copyFileSync('src/styles/design-system/README.md', path.join(distDir, 'README.md'));
  ...
  const packageInfo = {
    ...
    files: ['design-system.css', 'design-system.css.map', 'index.html', 'README.md', 'testing/'],
    keywords: ['design-system', 'accessibility', 'a11y', 'css', 'sass', 'components'],
